  ...
  return (
    <section className="how-it-works">
      <div className="title">
        <h2>How it woks</h2>
        <p>
          Our streamlined process makes it simple for you
          to book and confirm your vehicle.
        </p>
      </div>
      ...
      <div className="how-it-works-container">
        ...
        <div className="how-it-works-content">
          <div className="card">
            <div className="icon-container"><FaSearch className="icon" /></div>
            <div>
          ...
          <div className="card">
            <div className="icon-container"><HiOutlineCalendar className="icon" /></div>
            <div>
          ...
          <div className="card">
            <div className="icon-container"><BsEmojiSmile className="icon" /></div>
            <div>
