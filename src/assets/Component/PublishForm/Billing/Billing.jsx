      ...
      {step === 1 && (
        <div className="pvf-step">
          ...
          <div className="pvf-btn-right">
            <button className="pvf-btn pvf-btn-primary" onClick={nextStep}>
              Next
            </button>
          </div>
        </div>
        ...
        <div className="pvf-step">
          ...
          <div className="pvf-section">
            ...
            <div className="pvf-radio-group">
              <label>
                <input type="radio" name="payment" /> G-pay
              </label>
              <label>
          ...
          <div className="pvf-btn-row">
            <button className="pvf-btn pvf-btn-back" onClick={prevStep}>
              Back
            </button>
            <button className="pvf-btn pvf-btn-primary" onClick={nextStep}>
              Next
      ...
      {step === 3 && (
        <div className="pvf-step">
          ...
          <div className="pvf-btn-row">
            ...
            <button className="pvf-btn pvf-btn-confirm" onClick={() => {alert("Your vehicle has been successfully published!"); navigate('/');}}>Confirm now</button>
          </div>
        </div>
      )}
    </div>
